...
{
    // Straight up copied and pasted from Java's implementation.
    
    public static string ReadJavaUtf(this BinaryReader @in)
    {
        int utflen = @in.ReadUInt16BigEndian();
